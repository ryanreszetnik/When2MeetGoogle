...
export default function TermsOfService() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to When2MeetGoogle.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to When2MeetGoogle, accessible from{" "}
            <a
              href="https://when-2-meet-chrome.web.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://when-2-meet-chrome.web.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: ryanreszetnik@gmail.com</li>
      </ul>
    </>
  );
}
